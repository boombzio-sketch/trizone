...
const STATUS_COLOR = { pending: '#F59E0B', approved: '#10B981', rejected: '#F87171' }
    ...
    <View style={[s.card, { borderColor: sc + '30', borderTopColor: sc, borderTopWidth: 3 }]}>
      ...
      <View style={s.cardHeader}>
        ...
        <View style={{ alignItems: 'flex-end', gap: 4 }}>
          ...
          <View style={[s.statusBadge, { borderColor: STATUS_COLOR[status] + '60' }]}>
...
const s = StyleSheet.create({
  ...
  statusBadge: { borderWidth: 1, borderRadius: 5, paddingHorizontal: 6, paddingVertical: 1 },
